...
Docx 内部按 v2.5 固定结构（一至十一，共 11 个一级章节），编号遵循 §17.4：

| 章节 | 内容 | Docx 层级 |
|---|---|---|
| 一、标题建议 | 3 组标题 | h2 |
| 二、核心卖点 | 8 条卖点 | h2 |
| 三、详情文案 | 7 小节完整详情 | h2 + h3×7 |
| 四、9 图提示词 | 三段式提示词 | h2 |
| 五、SKU 命名 | 覆盖全颜色 / 版本 | h2 |
| 六、关键词 | 30+ 关键词 | h2 |
| 七、规格参数 | 参数表 | h2 |
| 八、包装清单 | 清单列表 | h2 |
| 九、风险提醒 | 合规提醒 | h2 |
| 十、图片汇总 | 9 张图按位置分节，每节含 h3「（N）图 N · 用途」+ 对应图片块 | h2 + h3×9 |
| 十一、Post-QA 报告 | 🟢/🟡/🔴 汇总 + 逐图诊断 + 修复建议 | h2 |
